...
+ Collect valid packets in each format, as generated by DIREWOLF, for the test suite.
+ Write unit tests for test suite.

Things to do: 
- Collect valid kenwood packets from a Kenwood TM-D710 and a TH-D74A 
